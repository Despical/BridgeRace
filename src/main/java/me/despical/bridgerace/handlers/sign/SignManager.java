...
public class SignManager implements Listener {
	...
	public void onSignChange(SignChangeEvent e) {
		if (!e.getPlayer().hasPermission("bridgerace.admin.sign.create") || !e.getLine(0).equalsIgnoreCase("[bridgerace]")) {
			return;
		}
	...
	public void onSignDestroy(BlockBreakEvent e) {
		...
		if (!e.getPlayer().hasPermission("bridgerace.admin.sign.break")) {
			e.setCancelled(true);
